...
- (void) configureSingleSlider
{
    ...
    self.singleSlider.upperValue = 500;
    ...
    self.singleSlider.maximumValue = 500;
...
- (void)configureRangeSlider {
    self.rangeSlider.upperValue = 60;
...
- (void) updateSingleSliderLabels
{
    ...
    self.lowerLbl.text = [NSString stringWithFormat:@"%.1fm", self.singleSlider.lowerValue];
    ...
    self.higherLbl.text = [NSString stringWithFormat:@"%.1fm", self.singleSlider.upperValue];
}
