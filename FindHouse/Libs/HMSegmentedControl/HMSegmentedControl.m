...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            BOOL selectionStyleNotBox = (self.selectionStyle != HMSegmentedControlSelectionStyleBox) && (self.selectionStyle != HMSegmentedControlSelectionStyleBoxRounded);
            // ruanyu
    ...
    if (self.selectedSegmentIndex != HMSegmentedControlNoSegment) {
        if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
            ...
            if (!self.selectionIndicatorStripLayer.superlayer) {
                ...
                // ruanyu
                if (self.selectionStyle == HMSegmentedControlSelectionStyleBoxRounded && !self.selectionIndicatorBoxLayer.superlayer) {
                    self.selectionIndicatorBoxLayer.frame = [self frameForFillerSelectionIndicator];
                    self.selectionIndicatorBoxLayer.cornerRadius = self.selectionIndicatorBoxLayer.frame.size.height/2;
        ...
        if (animated) {
            ...
            if(self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
                ...
                if ([self.selectionIndicatorStripLayer superlayer] == nil) {
                    ...
                    // ruanyu
                    if (self.selectionStyle == HMSegmentedControlSelectionStyleBoxRounded && [self.selectionIndicatorBoxLayer superlayer] == nil)
                        [self.scrollView.layer insertSublayer:self.selectionIndicatorBoxLayer atIndex:0];
                    // ruanyu
