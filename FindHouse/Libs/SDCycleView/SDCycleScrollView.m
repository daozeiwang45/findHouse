...
- (void)setupMainView
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(nextAction) name:@"pre" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(preAction) name:@"next" object:nil];
}
...
- (void)preAction {
    ...
    NSInteger page = x/kSCREEN_W;
    NSInteger next = (page+1)%_totalItemsCount;
    [_mainView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:next inSection:0] atScrollPosition:UICollectionViewScrollPositionNone animated:YES];
    [_timer invalidate];
    _timer = nil;
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case SDCycleScrollViewPageContolStyleAnimated:
        {
            ...
            // add 2015.12.31
            pageControl.dotImage = [UIImage imageNamed:@"hengline"];
            pageControl.currentDotImage = [UIImage imageNamed:@"xieline"];
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAliment == SDCycleScrollViewPageContolAlimentRight) {
        // changed by tom 2015.12.31
        x = self.mainView.sd_width - size.width - 25;
    }
    // changed by tom 2015.12.31
...
- (UICollectionViewFlowLayout *)flowLayout {
    return (UICollectionViewFlowLayout *)self.flowLayout;
