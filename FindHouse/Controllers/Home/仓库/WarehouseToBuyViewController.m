//
//  WarehouseToBuyViewController.m
//  FindHouse
//
...
static NSString *cellID = @"WarehouseToBuyCell";
@implementation WarehouseToBuyViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"WarehouseToBuyCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)searchResultAction {
    ...
    wareResultVC.houseKind = SaleKind;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WarehouseToBuyCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
