...
@property (nonatomic, strong) WarehouseToRentViewController *rentVC;
@property (nonatomic, strong) WarehouseToBuyViewController *buyVC;
...
- (void)viewDidLoad {
    ...
    _rentVC = [[WarehouseToRentViewController alloc] init];
...
- (void)segmentAction:(HMSegmentedControl*)sender
{
    ...
    if (vc == nil)
    {
        ...
        {
            case 0:
                vc = [[WarehouseToRentViewController alloc] init];
                self.rentVC = (WarehouseToRentViewController *)vc;
                break;
                
            case 1:
                vc = [[WarehouseToBuyViewController alloc] init];
                self.buyVC = (WarehouseToBuyViewController *)vc;
                break;
