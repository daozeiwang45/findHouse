//
//  WarehouseToRentViewController.m
//  FindHouse
//
...
#import "WarehouseToRentViewController.h"
#import "HMSegmentedControl.h"
#import "WarehouseToRentCell.h"
#import "bxViewAdditions.h"
#import "OfficeSearchFooter.h"
#import "WarehouseResultViewController.h"
#import "WareRecmdViewController.h"

@interface WarehouseToRentViewController ()
{
...
static NSString *cellID = @"WarehouseToRentCell";
@implementation WarehouseToRentViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"WarehouseToRentCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)searchResultAction {
    WarehouseResultViewController *wareResultVC = [[WarehouseResultViewController alloc] init];
    wareResultVC.houseKind = RentKind;
    [self.navigationController pushViewController:wareResultVC animated:YES];
}

- (void)recmdAction {
    WareRecmdViewController *recmdVC = [[WareRecmdViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WarehouseToRentCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
