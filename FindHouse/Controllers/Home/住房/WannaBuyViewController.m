...
@interface WannaBuyViewController ()
...
@end
static NSString *cellID = @"buyRangeCell";

@implementation WannaBuyViewController
...
- (void)viewDidLoad {
    ...
    [self _initUI];
    [self startLocation];
    [_tableView registerNib:[UINib nibWithNibName:@"BuyRangeCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)_initUI {
    ...
    _footer.bottomIV.image = [UIImage imageNamed:@"bottom_blue"];
    [_footer.oneRentBtn setImage:[UIImage imageNamed:@"oneBuy"] forState:UIControlStateNormal];
    _tableView.tableFooterView = footView;
    UITapGestureRecognizer *resultTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(searchResultAction)];
    _footer.recommendLbl.userInteractionEnabled = YES;
    [_footer.recommendLbl addGestureRecognizer:resultTap];
...
// 跳转一键租房页面
- (void)oneRentAction {
    OneBuyViewController *oneBuyVC = [self.storyboard instantiateViewControllerWithIdentifier:@"oneBuy"];
    [self.navigationController pushViewController:oneBuyVC animated:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BuyRangeCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
