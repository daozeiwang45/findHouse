...
@interface OneRentViewController ()<YSLDraggableCardContainerDelegate, YSLDraggableCardContainerDataSource>
...
@implementation OneRentViewController
...
- (void)qianfangAction {
    ...
    qianRecmdVC.houseKind = RentKind;
