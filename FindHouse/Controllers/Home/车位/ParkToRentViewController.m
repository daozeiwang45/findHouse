...
static NSString *cellID = @"ParkToRentCell";
@implementation ParkToRentViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"ParkToRentCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)searchResultAction {
    ...
    parkResultVC.houseKind = RentKind;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ParkToRentCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
