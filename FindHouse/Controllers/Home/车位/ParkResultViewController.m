...
@interface ParkResultViewController ()<UIGestureRecognizerDelegate>
{
    UIButton *btn,*preBtn;
}
...
@implementation ParkResultViewController
...
- (void)viewDidLoad {
    ...
    currentSection = -1;
    _sectionArr = [NSMutableArray arrayWithArray:@[@[@"最近",@"最远"],@[@"最高",@"最低"],@[@"地面固定停车位",@"地下固定停车位"]]];
