...
@property (nonatomic, strong) ParkToRentViewController *rentVC;
@property (nonatomic, strong) ParkToBuyViewController *buyVC;
...
- (void)viewDidLoad {
    ...
    _rentVC = [[ParkToRentViewController alloc] init];
...
- (void)segmentAction:(HMSegmentedControl*)sender
{
    ...
    if (vc == nil)
    {
        ...
        {
            case 0:
                vc = [[ParkToRentViewController alloc] init];
                self.rentVC = (ParkToRentViewController *)vc;
                break;
                
            case 1:
                vc = [[ParkToBuyViewController alloc] init];
                self.buyVC = (ParkToBuyViewController *)vc;
                break;
