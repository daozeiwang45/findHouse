...
static NSString *cellID = @"WorkshopToBuyCell";
@implementation WorkshopToBuyViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"WorkshopToBuyCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)searchResultAction {
    ...
    workResultVC.houseKind = SaleKind;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WorkshopToBuyCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
