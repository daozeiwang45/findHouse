//
//  WorkshopToRentViewController.m
//  FindHouse
//
...
@interface WorkshopToRentViewController ()
{
...
static NSString *cellID = @"WorkshopToRentCell";
@implementation WorkshopToRentViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"WorkshopToRentCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)searchResultAction {
    WorkshopResultViewController *workResultVC = [[WorkshopResultViewController alloc] init];
    workResultVC.houseKind = RentKind;
    [self.navigationController pushViewController:workResultVC animated:YES];
}

- (void)recmdAction {
    WorkshopRecmdViewController *recmdVC = [[WorkshopRecmdViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WorkshopToRentCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
