//
//  OfficeSearchResultViewController.m
//  FindHouse
//
...
@interface OfficeSearchResultViewController ()<UIGestureRecognizerDelegate>
{
    UIButton *btn,*preBtn;
}
...
@implementation OfficeSearchResultViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (tableView == _tableView) {
        OfficeDetailViewController *detailVC = [[OfficeDetailViewController alloc] init];
