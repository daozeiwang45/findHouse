//
//  OfficeWannaRentViewController.m
//  FindHouse
//
...
#import "OfficeWannaRentViewController.h"
#import "bxViewAdditions.h"
#import "OfficeWannaRentCell.h"
#import "OfficeSearchFooter.h"
#import "OfficeSearchResultViewController.h"
#import "OfficeRecmdViewController.h"

@interface OfficeWannaRentViewController ()
{
...
static NSString *cellID = @"officeWannaRentCell";
@implementation OfficeWannaRentViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"OfficeWannaRentCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)searchResultAction {
    OfficeSearchResultViewController *resultVC = [[OfficeSearchResultViewController alloc] init];
    resultVC.houseKind = RentKind;
    [self.navigationController pushViewController:resultVC animated:YES];
}

- (void)recmdAction {
    OfficeRecmdViewController *recmdVC = [[OfficeRecmdViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    OfficeWannaRentCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
