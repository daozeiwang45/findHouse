...
@interface OfficeDetailViewController ()<SDCycleScrollViewDelegate,UIGestureRecognizerDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
- (void)_initUI {
    ...
    if (_houseKind == RentKind) {
        ...
        UIView *centerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kSCREEN_W, 554)];
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kSCREEN_W, kSCREEN_H-135-64) style:UITableViewStylePlain];
        UIView *centerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kSCREEN_W, 554-48-37)];
        _header.frame = centerView.bounds;
        [centerView addSubview:_header];
        _tableView.tableHeaderView = centerView;
        _saleV.hidden = NO;
