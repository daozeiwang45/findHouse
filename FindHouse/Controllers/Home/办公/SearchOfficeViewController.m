...
@interface SearchOfficeViewController ()
@property (nonatomic, strong) HMSegmentedControl *segCtrl;
@property (nonatomic, strong) UIPageViewController *pageViewController;
@property (nonatomic, strong) OfficeWannaRentViewController *rentVC;
@property (nonatomic, strong) OfficeWannaBuyViewController *buyVC;

@end

@implementation SearchOfficeViewController
...
- (void)viewDidLoad {
    ...
    _rentVC = [[OfficeWannaRentViewController alloc] init];
...
- (void)segmentAction:(HMSegmentedControl*)sender
{
    ...
    if (vc == nil)
    {
        ...
        {
            case 0:
                vc = [[OfficeWannaRentViewController alloc] init];
                self.rentVC = (OfficeWannaRentViewController *)vc;
                break;
                
            case 1:
                vc = [[OfficeWannaBuyViewController alloc] init];
                self.buyVC = (OfficeWannaBuyViewController *)vc;
                break;
