//
//  OfficeWannaBuyViewController.m
//  FindHouse
//
...
static NSString *cellID = @"officeWannaBuyCell";
@implementation OfficeWannaBuyViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"OfficeWannaBuyCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    OfficeWannaBuyCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
