...
static NSString *cellID = @"ShopToRentCell";
@implementation ShopToRentViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"ShopToRentCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)searchResultAction {
    ShopResultViewController *shopResultVC = [[ShopResultViewController alloc] init];
    shopResultVC.houseKind = RentKind;
    [self.navigationController pushViewController:shopResultVC animated:YES];
}

- (void)recmdAction {
    ShopRecmdViewController *recmdVC = [[ShopRecmdViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ShopToRentCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
