...
@property (nonatomic, strong) ShopToRentViewController *rentVC;
@property (nonatomic, strong) ShopToBuyViewController *buyVC;
@end
...
- (void)viewDidLoad {
    ...
    _rentVC = [[ShopToRentViewController alloc] init];
...
- (void)segmentAction:(HMSegmentedControl*)sender
{
    ...
    if (vc == nil)
    {
        ...
        {
            case 0:
                vc = [[ShopToRentViewController alloc] init];
                self.rentVC = (ShopToRentViewController *)vc;
                break;
                
            case 1:
                vc = [[ShopToBuyViewController alloc] init];
                self.buyVC = (ShopToBuyViewController *)vc;
                break;
