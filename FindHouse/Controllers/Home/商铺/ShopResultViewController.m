...
@interface ShopResultViewController ()<UIGestureRecognizerDelegate>
{
    UIButton *btn,*preBtn;
}
...
@implementation ShopResultViewController
...
- (void)viewDidLoad {
    ...
    currentSection = -1;
    _sectionArr = [NSMutableArray arrayWithArray:@[@[@"最近",@"最远"],@[@"最高",@"最低"],@[@"最大",@"最小",@""],@[@"奢华装修",@"精装修",@"中装修",@"简装修",@"毛坯"]]];
    NSArray *titles = @[@"距离",@"价格",@"面积",@"装修"];
