...
static NSString *cellID = @"ShopToBuyCell";
@implementation ShopToBuyViewController
...
- (void)_initUI {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"ShopToBuyCell" bundle:nil] forCellReuseIdentifier:cellID];
...
- (void)searchResultAction {
    ...
    shopResultVC.houseKind = SaleKind;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ShopToBuyCell *cell = [_tableView dequeueReusableCellWithIdentifier:cellID forIndexPath:indexPath];
